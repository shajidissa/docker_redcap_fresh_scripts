...
mysql -uroot -proot redcap < redcap/redcap_v${redcap_version}/redcap/redcap_v${redcap_version}/Resources/sql/upgrade_7.01.00.sql
mysql -uroot -proot redcap < redcap/redcap_v${redcap_version}/redcap/redcap_v${redcap_version}/Resources/sql/upgrade_7.01.02.sql
mysql -uroot -proot redcap < redcap/redcap_v${redcap_version}/redcap/redcap_v${redcap_version}/Resources/sql/upgrade_7.02.00.sql
mysql -uroot -proot redcap < redcap/redcap_v${redcap_version}/redcap/redcap_v${redcap_version}/Resources/sql/upgrade_7.02.01.sql
mysql -uroot -proot redcap < redcap/redcap_v${redcap_version}/redcap/redcap_v${redcap_version}/Resources/sql/upgrade_7.03.00.sql
mysql -uroot -proot redcap < redcap/redcap_v${redcap_version}/redcap/redcap_v${redcap_version}/Resources/sql/upgrade_7.03.01.sql
mysql -uroot -proot redcap < redcap/redcap_v${redcap_version}/redcap/redcap_v${redcap_version}/Resources/sql/upgrade_7.03.04.sql
mysql -uroot -proot redcap < redcap/redcap_v${redcap_version}/redcap/redcap_v${redcap_version}/Resources/sql/upgrade_7.03.05.sql
mysql -uroot -proot redcap < redcap/redcap_v${redcap_version}/redcap/redcap_v${redcap_version}/Resources/sql/upgrade_7.03.06.sql
mysql -uroot -proot redcap < redcap/redcap_v${redcap_version}/redcap/redcap_v${redcap_version}/Resources/sql/upgrade_7.04.00.sql
mysql -uroot -proot redcap < redcap/redcap_v${redcap_version}/redcap/redcap_v${redcap_version}/Resources/sql/upgrade_7.04.01.sql
mysql -uroot -proot redcap < redcap/redcap_v${redcap_version}/redcap/redcap_v${redcap_version}/Resources/sql/upgrade_7.04.03.sql
mysql -uroot -proot redcap < redcap/redcap_v${redcap_version}/redcap/redcap_v${redcap_version}/Resources/sql/upgrade_7.05.01.sql
